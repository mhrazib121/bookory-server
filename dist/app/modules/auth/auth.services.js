...
const userSignUp = user =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!user.password && user.role === "buyer") {
      user.password = config_1.default.buyer_pass;
    }
    if (!user.password && user.role === "seller") {
      user.password = config_1.default.seller_pass;
    }
    if (user.role === "buyer") {
      user.income = 0;
    }
...
const loginUser = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isExistUser = yield user_model_1.User.isUserExist(phoneNumber);
    if (!isExistUser) {
    ...
    const isPasswordMatched = yield user_model_1.User.isPasswordMatched(
      password,
